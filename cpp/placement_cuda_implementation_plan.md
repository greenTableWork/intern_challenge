...
- [x] Add debug-mode rendering for the cells generated by the CUDA tensor setup path.
...
- [ ] Initialize cell positions in CUDA without host scalar extraction.
- [ ] Add rendering capabilities to the CUDA path for generated placement states.
...
- Acceptance checks:
  ...
  - Debug builds of `placement_cuda` render `placement_cuda_tensor_setup_debug.png`.
